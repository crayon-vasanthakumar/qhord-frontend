...
exports.ArchitectNode = void 0;
const llm_config_1 = require("../../utils/llm-config");
const architect_prompt_1 = require("../../prompts/architect-prompt");
const manifest_builder_1 = require("../../utils/manifest-builder");
class ArchitectNode {
    async invoke(state) {
        try {
            if (!state.intent) {
    ...
    buildLogicalManifest(intent, activeTools) {
        try {
            ...
            const manifest = manifest_builder_1.ManifestBuilder.buildFromIntent(intent, activeTools);
...
exports.ArchitectNode = ArchitectNode;
