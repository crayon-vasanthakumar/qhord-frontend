...
exports.ARCHITECT_PROMPT = void 0;
exports.ARCHITECT_PROMPT = `You are a GTM campaign architect. Your job is to take the parsed intent and create a detailed campaign plan using only the tools that the client has active.
