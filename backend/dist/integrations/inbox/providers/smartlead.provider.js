...
exports.smartleadProvider = void 0;
...
async function liveFetch(apiKey) {
    const data = await (0, http_1.httpJson)(`${BASE}/master-inbox/messages`, {
...
exports.smartleadProvider = {
    ...
    async sendMessage(ctx, externalConversationId, body) {
        ...
        try {
            ...
            const data = await (0, http_1.httpJson)(`${BASE}/master-inbox/reply`, {
                method: 'POST',
