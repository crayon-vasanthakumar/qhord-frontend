...
router.get('/jobs/:jobId', auth_1.requireAuth, async (req, res) => {
    try {
...
router.post('/pause', auth_1.requireAuth, async (req, res) => {
    try {
...
router.post('/resume', auth_1.requireAuth, async (req, res) => {
    try {
...
router.post('/clear', auth_1.requireAuth, async (req, res) => {
    try {
...
router.post('/trigger-approved', auth_1.requireAuth, async (req, res) => {
    try {
