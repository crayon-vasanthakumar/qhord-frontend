...
router.post('/', async (req: Request, res: Response) => {
  const { 
    name, description, region, account_owner, industry, status, website, priority,
    icp_summary, strategy_notes, channels, connected_tools, approval_mode, max_daily_sends, require_crm_approval
  } = req.body as any;
  if (!name) {
